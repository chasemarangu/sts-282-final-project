...
The objective of this project was to create a visualization tool which makes it easy to plot vector field lines (streamlines) of
 ...
 2) Click the buttons in the GUI to add different charge distributions.
 Currently, only point charges and uniformly charged line segments are supported, but I hope to add numerous more features in the future.
